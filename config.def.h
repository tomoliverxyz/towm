...
/* bar settings */
static const int leftlayout = 1; /* 0 means show layout indicator after tags */
static const int showwindowtitle = 0; /* 0 means hide window title */
...
static const Layout layouts[] = {
	/* symbol   enabled 	arrange function */
